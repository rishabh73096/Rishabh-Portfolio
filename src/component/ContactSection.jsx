            ...
            <div className="flex flex-col lg:flex-row lg:ml-20 lg:gap-36">
                ...
                <div className="flex flex-col p-3">
                    <form>
                        ...
                        <textarea rows="3"  name="message" id="message" className="bg-transparent p-3 outline-none border focus:border-purple-500 focus:pl-8 rounded transition-all delay-100 border-white gradiant-text font-mono text-xl lg:text-2xl mb-5 lg:mb-10 w-full lg:w-[30vw]"/>
